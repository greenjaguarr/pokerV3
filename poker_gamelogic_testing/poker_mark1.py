...
if __name__ == "__main__":
    ...
    print("4",calc_waarde(hand4))  # {'resultaat': 'royal flush', 'hoogste kaart': 'A'}
    print("5",calc_waarde(hand5))  # {'resultaat': 'straight flush', 'hoogste kaart': '6'}
    print("6",calc_waarde(hand6))  # {'resultaat': 'royal flush', 'hoogste kaart': 'A'}
    ...
    print("11", calc_waarde(hand11))  # {'resultaat': 'straight', 'hoogste kaart': '8'}
    print("12", calc_waarde(hand12))  # {'resultaat': 'flush', 'hoogste kaart': 'K'}
    print("13", calc_waarde(hand13))  # {'resultaat': 'full house', 'hoogste kaart': '3'}
    print("14", calc_waarde(hand14))  # {'resultaat': 'four of a kind', 'hoogste kaart': '2'}
    print("15", calc_waarde(hand15))  # {'resultaat': 'three of a kind', 'hoogste kaart': '2'}
    print("16", calc_waarde(hand16))  # {'resultaat': 'two pair', 'hoogste kaart': '3'}
    print("17", calc_waarde(hand17))  # {'resultaat': 'one pair', 'hoogste kaart': '2'}
    print("18", calc_waarde(hand18))  # {'resultaat': 'high card', 'hoogste kaart': 'V'}